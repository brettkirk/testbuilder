...
describe('MasterCard', function() {
  ...
  it('has a prefix of 51 and a length 16', function() {
    detectNetwork('5112345678901234').should.equal('MasterCard');
  });
 
  it('has a prefix of 52 and a length 16', function() {
    detectNetwork('5212345678901234').should.equal('MasterCard');
  });
 
  it('has a prefix of 53 and a length 16', function() {
...
describe('China UnionPay', function() {
  it('has a prefix from 622126 to 622925 and a length of 16', function(){
    var str = '';
    for (var i = 622126; i < 622926; i++){
      detectNetwork(str.concat(String(i), '1234567890')).should.equal('China UnionPay');
    };
  });
  it('has a prefix from 622126 to 622925 and a length of 17', function(){
    var str = '';
    for (var i = 622126; i < 622926; i++){
      detectNetwork(str.concat(String(i), '12345678901')).should.equal('China UnionPay');
    };
  });
  it('has a prefix from 622126 to 622925 and a length of 18', function(){
    var str = '';
    for (var i = 622126; i < 622926; i++){
      detectNetwork(str.concat(String(i), '123456789012')).should.equal('China UnionPay');
    };
  });
  it('has a prefix from 622126 to 622925 and a length of 19', function(){
    var str = '';
    for (var i = 622126; i < 622926; i++){
      detectNetwork(str.concat(String(i), '1234567890123')).should.equal('China UnionPay');
    };
  });
  it('has a prefix from 624 to 626 and a length of 16', function(){
    var str = '';
    for (var i = 624; i < 627; i++){
      detectNetwork(str.concat(String(i), '1231234567890')).should.equal('China UnionPay');
    };
  });
  it('has a prefix from 624 to 626 and a length of 17', function(){
    var str = '';
    for (var i = 624; i < 627; i++){
      detectNetwork(str.concat(String(i), '12312345678901')).should.equal('China UnionPay');
    };
  });
  it('has a prefix from 624 to 626 and a length of 18', function(){
    var str = '';
    for (var i = 624; i < 627; i++){
      detectNetwork(str.concat(String(i), '123123456789012')).should.equal('China UnionPay');
    };
  });
  it('has a prefix from 624 to 626 and a length of 19', function(){
    var str = '';
    for (var i = 624; i < 627; i++){
      detectNetwork(str.concat(String(i), '1231234567890123')).should.equal('China UnionPay');
    };
  });
  it('has a prefix from 6282 to 6288 and a length of 16', function(){
    var str = '';
    for (var i = 6282; i < 6289; i++){
      detectNetwork(str.concat(String(i), '121234567890')).should.equal('China UnionPay');
    };
  });
  it('has a prefix from 6282 to 6288 and a length of 17', function(){
    var str = '';
    for (var i = 6282; i < 6289; i++){
      detectNetwork(str.concat(String(i), '1212345678901')).should.equal('China UnionPay');
    };
  });
  it('has a prefix from 6282 to 6288 and a length of 18', function(){
    var str = '';
    for (var i = 6282; i < 6289; i++){
      detectNetwork(str.concat(String(i), '12123456789012')).should.equal('China UnionPay');
    };
  });
  it('has a prefix from 6282 to 6288 and a length of 19', function(){
    var str = '';
    for (var i = 6282; i < 6289; i++){
      detectNetwork(str.concat(String(i), '121234567890123')).should.equal('China UnionPay');
    };
  });
});

describe('Switch', function() {
  it('has a prefix from 4903 and a length of 16', function(){
    detectNetwork('4903123456789012').should.equal('Switch');
  });
  it('has a prefix from 4903 and a length of 18', function(){
    detectNetwork('490312345678901234').should.equal('Switch');
  });
  it('has a prefix from 4903 and a length of 19', function(){
    detectNetwork('4903123456789012345').should.equal('Switch');
  });
  it('has a prefix from 4905 and a length of 16', function(){
    detectNetwork('4905123456789012').should.equal('Switch');
  });
  it('has a prefix from 4905 and a length of 18', function(){
    detectNetwork('490512345678901234').should.equal('Switch');
  });
  it('has a prefix from 4905 and a length of 19', function(){
    detectNetwork('4905123456789012345').should.equal('Switch');
  });
  it('has a prefix from 4911 and a length of 16', function(){
    detectNetwork('4911123456789012').should.equal('Switch');
  });
  it('has a prefix from 4911 and a length of 18', function(){
    detectNetwork('491112345678901234').should.equal('Switch');
  });
  it('has a prefix from 4911 and a length of 19', function(){
    detectNetwork('4911123456789012345').should.equal('Switch');
  });
  it('has a prefix from 4936 and a length of 16', function(){
    detectNetwork('4936123456789012').should.equal('Switch');
  });
  it('has a prefix from 4936 and a length of 18', function(){
    detectNetwork('493612345678901234').should.equal('Switch');
  });
  it('has a prefix from 4936 and a length of 19', function(){
    detectNetwork('4936123456789012345').should.equal('Switch');
  });
  it('has a prefix from 564182 and a length of 16', function(){
    detectNetwork('5641823456789012').should.equal('Switch');
  });
  it('has a prefix from 564182 and a length of 18', function(){
    detectNetwork('564182345678901234').should.equal('Switch');
  });
  it('has a prefix from 564182 and a length of 19', function(){
    detectNetwork('5641823456789012345').should.equal('Switch');
  });
  it('has a prefix from 633110 and a length of 16', function(){
    detectNetwork('6331103456789012').should.equal('Switch');
  });
  it('has a prefix from 633110 and a length of 18', function(){
    detectNetwork('633110345678901234').should.equal('Switch');
  });
  it('has a prefix from 633110 and a length of 19', function(){
    detectNetwork('6331103456789012345').should.equal('Switch');
  });
  it('has a prefix from 6333 and a length of 16', function(){
    detectNetwork('6333123456789012').should.equal('Switch');
  });
  it('has a prefix from 6333 and a length of 18', function(){
    detectNetwork('633312345678901234').should.equal('Switch');
  });
  it('has a prefix from 6333 and a length of 19', function(){
    detectNetwork('6333123456789012345').should.equal('Switch');
  });
  it('has a prefix from 6759 and a length of 16', function(){
    detectNetwork('6759123456789012').should.equal('Switch');
  });
  it('has a prefix from 6759 and a length of 18', function(){
    detectNetwork('675912345678901234').should.equal('Switch');
  });
  it('has a prefix from 6759 and a length of 19', function(){
